...
import { addNewSegment } from "../../store/actions";
...
const AddNewSagment = ({ isOpen, onClose, onApply }) => {
            ...
            >
                ...
                <div className="offcanvas-header border-bottom py-3 px-4">
                    <h5 className="offcanvas-title fw-semibold">
                        <i className="fas fa-plus me-1"></i> Add New Sagment
                    </h5>
                            ...
                            <Col lg="12">
                                ...
                                >
                                    <Row>
                                        <Col md="12">
                                            <div className="mb-3">
                                                <Label>Sagment Type</Label>
                                                <Select
                                                    name="type"
                                                    placeholder="Select Type"
                                                    value={TypeData.find(opt => opt.value === validation.values.type)}
